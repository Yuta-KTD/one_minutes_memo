...
abstract class $LocalUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String password, String email, String? userName});
}
...
class _$_LocalUser implements _LocalUser {
  const _$_LocalUser(
      {required this.password, required this.email, this.userName});
  ...
  @override
  String toString() {
    return 'LocalUser(password: $password, email: $email, userName: $userName)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, password, email, userName);
...
abstract class _LocalUser implements LocalUser {
  const factory _LocalUser(
      ...
      final String? userName}) = _$_LocalUser;
